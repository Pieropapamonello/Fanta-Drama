...
const firstCards: StarterCard[] = [
  ...
  { slug: 'torre-di-brindisi', title: 'Torre di Brindisi', description: 'Pronostica se la piramide di calici resistera fino al brindisi piu atteso della notte.', prompt: 'crystal champagne tower wrapped in a violet ribbon', rarity: 'LEGENDARY', type: 'YES_NO', basePoints: 65, imageUrl: '/cards/community/torre-di-brindisi-gpt.png' },
  { slug: 'dado-del-caos', title: 'Dado del Caos', description: 'Pronostica se il prossimo lancio cambiera le alleanze della crew prima dellalba.', prompt: 'neon roulette wheel with floating gold dice', rarity: 'EPIC', type: 'YES_NO', basePoints: 55, imageUrl: '/cards/community/dado-del-caos-gpt.png' },
]
...
const firstAvatars: StarterAvatar[] = [
  ...
  { slug: 'emerald-rebel', title: 'Emerald rebel', note: 'Eleganza, energia e zero paura del drama', prompt: 'woman with violet curls and emerald jacket', imageUrl: '/avatars/common/emerald-rebel.png' },
  { slug: 'cobalt-captain', title: 'Cobalt captain', note: 'Sorriso sicuro, ritmo impossibile da fermare', prompt: 'man with silver hair and cobalt satin jacket', imageUrl: '/avatars/common/cobalt-captain.png' },
]
