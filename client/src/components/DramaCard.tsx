...
const artFromSeed = (seed = '') => artworkKeys[[...seed].reduce((value, char) => value + char.charCodeAt(0), 0) % artworkKeys.length]
const typeNames: Record<string, string> = { YES_NO: 'Previsione', PICK_CHARACTER: 'Bersaglio', MULTI_CHOICE: 'Scelta', NUMBER: 'Numero', RANGE: 'Range', TIME: 'Tempo', TEXT: 'Parola', FIRST_ACTION: 'Azione', ORDER: 'Ordine' }
export type DramaCardData = { id?: string, slug?: string, title: string, description?: string, effect?: string, flavor?: string, rarity?: string, type?: string, basePoints?: number, imageKey?: string, imageUrl?: string, librarySlug?: string, catalogCardId?: string, creatorName?: string }
