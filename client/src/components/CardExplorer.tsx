...
export function startEpicAmbience() {
  ...
  const progression = [[130.81, 164.81, 196], [146.83, 185, 220], [110, 138.59, 164.81], [123.47, 155.56, 196]]
  const melody = [523.25, 659.25, 783.99, 659.25, 587.33, 659.25, 493.88, 587.33]
