...
export default function CreateCard() {
  ...
  return <form onSubmit={handleSubmit(onSubmit)} className="max-w-md">
    ...
    <ImageForge kind="CARD" imageUrl={watch('imageUrl')} onChange={(url, storagePath, imageSource) => { setValue('imageUrl', url, { shouldValidate: true }); setValue('imageStoragePath', storagePath); setValue('imageSource', imageSource) }} />
